...
dotnet add reference path/to/corndogs.csproj
...
public static class CsilRpcExample
{
    ...
    {
        var client = new CorndogsClient(new HttpRpcCarrier("http://localhost:5080"));
        var response = client.SubmitTask(new SubmitTaskRequest { Queue = "example", CurrentState = "example", AutoTargetState = "example", Timeout = 0, Payload = System.Array.Empty<byte>(), Priority = 0 });
...
public static class CsilDatagramsExample
{
    ...
    public static void Run()
    {
        ...
        var req = new SubmitTaskRequest { Queue = "example", CurrentState = "example", AutoTargetState = "example", Timeout = 0, Payload = System.Array.Empty<byte>(), Priority = 0 };
        ...
        if (inbound is not null)
        {
            ...
            SubmitTaskResponse resp = Codec.Decode<SubmitTaskResponse>(dg.Payload);
