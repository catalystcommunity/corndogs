...
client = CorndogsClient.new(HttpRpcTransport.new("http://localhost:5080"))
resp = client.submit_task(SubmitTaskRequest.new(queue: "example", current_state: "example", auto_target_state: "example", timeout: 0, payload: "".b, priority: 0))
puts resp.inspect
```
...
req = SubmitTaskRequest.new(queue: "example", current_state: "example", auto_target_state: "example", timeout: 0, payload: "".b, priority: 0)
